...
public class GroupChatsActivity extends AppCompatActivity {
    ...
    private void intializeFields() {
        ...
        UserInputText=(EditText)findViewById(R.id.input_group_message);
    ...
    private void SaveMessageInfotoDatabase() {
        ...
        String message=UserInputText.getText().toString();
    ...
    private void DisplayMessages(DataSnapshot dataSnapshot) {
        ...
        while (iterator.hasNext()){
            ...
            displayTextMessage.setBackgroundResource(R.drawable.sender_messages_layout);
